...
public class CommonUtil {
	...
	//첨부파일 업로드/다운로드/삭제/인서트/수정에 모두 사용될 저장경로를 1개지정해서 전역으로 사용
	@Resource(name="uploadPath")
	private String uploadPath;//root-context 업로드경로 클래스빈의 id값을 받아서
	...
	//파일 업로드 공통 메서드(Admin컨트롤러에서사용 + Home컨트롤러에서도 사용)
