          ...
          <form name="form_write" method="post" action="/admin/board/board_update" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <!-- 위 div_file_delete 영역이름은 첨부파일을 개별Ajax 삭제할때 필요 -->
                  ...
                  <p class="text-muted">
                  	<a href="/download?save_file_name=${board_save_file_names[idx]}&real_file_name=${boardVO.real_file_names[idx]}">
                ...
                <div class="mb-2"></div>
                  ...
                  <div class="custom-file col-12"></div>
              </div>
            </div>
            <!-- /.card-body -->
            ...
            <div class="card-footer text-right">
              ...
              <a href="/admin/board/board_view?bno=${boardVO.bno}&page=${pageVO.page}&search_type${search_type}" class="btn btn-warning">뷰화면</a>
            </div>
...
<script src="/resoures/admin/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
