...
public class DataSourceTest {
	...
	//Inject 자바8부터 지원, 그럼, 이전 자바7에서 @Autowired로 객체를 만들었슴.
	...
	public void oldQueryTest() throws Exception {
		...
		//직접쿼리를 날립니다. 날리기전 쿼리문자 객체생성statement
		 ...
		 //예전 방식으로 더미데이터(샘플데이터)를 100개를 입력합니다.
			 ...
			 */
		 //인서트,업데이트,삭제시 sql디벨러퍼에서는 커밋이 필수지만, 외부 java클래스 인섵,할때는 자동커밋이 됩니다.
		 //테이블에 입력되어 있는 레코드셋를 select 퀴리 stmt문장으로 가져옴(아래)
